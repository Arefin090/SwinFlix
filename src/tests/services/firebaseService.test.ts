...
describe('Firebase Service', () => {
  ...
  describe('Authentication', () => {
    ...
    it('should handle sign up error', async () => {
      ...
      await expect(firebaseService.signUp('test@example.com', 'password'))
    ...
    it('should handle sign out error', async () => {
      ...
      await expect(firebaseService.signOut())
  ...
  describe('Watchlist Management', () => {
    it('should add movie to watchlist', async () => {
      ...
      const result = await firebaseService.addToWatchlist('user-123', mockMovie)
    ...
    it('should handle add to watchlist error', async () => {
      ...
      await expect(firebaseService.addToWatchlist('user-123', mockMovie))
    ...
    it('should handle get watchlist error', async () => {
      ...
      await expect(firebaseService.getWatchlist('user-123'))
        .rejects.toThrow('Failed to fetch watchlist. Please try again.')
    })
    ...
    it('should handle remove from watchlist error', async () => {
      ...
      await expect(firebaseService.removeFromWatchlist('watchlist-1'))
        .rejects.toThrow('Failed to remove movie from watchlist. Please try again.')
    })
  ...
  describe('Error Messages', () => {
    it('should return correct error messages for auth codes', async () => {
      ...
      for (const testCase of testCases) {
        vi.mocked(signInWithEmailAndPassword).mockRejectedValue({ code: testCase.code })
        
        await expect(firebaseService.signIn('test@example.com', 'password'))
