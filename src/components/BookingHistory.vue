<template>
  <div class="min-h-screen bg-black">
      ...
      <div class="container mx-auto px-6 py-8">
        ...
        <div v-else-if="bookings.length === 0" class="text-center py-20">
          <div class="max-w-md mx-auto">
            ...
            <h2 class="text-2xl font-bold text-white mb-4">Your list is empty</h2>
            <p class="text-gray-400 mb-8">Movies and shows you add to your list will appear here.</p>
            <router-link 
              to="/" 
              class="bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105"
            >
              Browse Movies
            </router-link>
          </div>
          ...
          <div class="grid grid-cols-1 gap-4 mb-8">
            ...
            >
              <div class="flex items-center p-6">
                ...
                <div class="w-16 h-24 bg-gray-700 rounded-lg flex items-center justify-center flex-shrink-0 mr-6">
                ...
                <div class="flex-1 min-w-0">
                  <h3 class="text-lg font-semibold text-white mb-2 group-hover:text-gray-300 transition-colors">
                    {{ booking.title }}
                  </h3>
                ...
                <div class="flex items-center space-x-3">
                  <button 
                    ...
                    class="bg-white text-black hover:bg-gray-200 font-semibold py-2 px-4 rounded-lg transition-all duration-200 flex items-center space-x-2"
                  >
                  ...
                  <button 
                    ...
                    class="text-gray-400 hover:text-red-400 p-2 rounded-lg hover:bg-gray-800 transition-all duration-200"
    ...
    <div 
      v-if="showToast" 
      class="fixed top-4 right-4 z-50 bg-green-600 text-white p-4 rounded-lg shadow-lg transition-all duration-300"
    >
      {{ toastMessage }}
    </div>
  </div>
