...
describe('Auth Store', () => {
  ...
  it('should handle sign in error', async () => {
    ...
    vi.mocked(firebaseService.signIn).mockRejectedValue(new Error(errorMessage))
    
    await expect(authStore.signIn('test@example.com', 'wrongpassword')).rejects.toThrow(errorMessage)
